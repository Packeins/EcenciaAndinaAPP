...
-- Módulo 2: Configuración de Productos
...
-- Módulo 4: Monedero Virtual (Saldos)
...
-- Módulo 5: Operación y Ventas (Órdenes)
...
CREATE TABLE public.Ordenes (
  ...
  canal_origen text, -- Enum o texto libre para métricas rápidas
  created_at timestamp with time zone default now(),
  created_by uuid,
  updated_at timestamp with time zone default now(),
  updated_by uuid
