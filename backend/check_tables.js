...
async function checkTables() {
  ...
  try {
    ...
    console.error('Plural catch:', e.message);
  }
  ...
  try {
    ...
    console.error('Lower Plural catch:', e.message);
  }
  ...
  try {
    ...
    console.error('Singular catch:', e.message);
  }
  ...
  try {
    ...
    console.error('Lower Singular catch:', e.message);
  }
}
